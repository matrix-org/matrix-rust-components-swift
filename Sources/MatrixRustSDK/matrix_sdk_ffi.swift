...
public struct CreateRoomParameters {
    ...
    public init(
        ...
        invite: [String]? = nil, 
        avatar: String? = nil, 
        powerLevelContentOverride: PowerLevels? = nil) {
        self.name = name
        self.topic = topic
...
public enum RoomListEntriesDynamicFilterKind {
    ...
    case none
    case normalizedMatchRoomName(
        pattern: String
    )
    case fuzzyMatchRoomName(
        pattern: String
    )
}
...
public struct FfiConverterTypeRoomListEntriesDynamicFilterKind: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RoomListEntriesDynamicFilterKind {
        ...
        case 1: return .all(
            filters: try FfiConverterSequenceTypeRoomListEntriesDynamicFilterKind.read(from: &buf)
        )
