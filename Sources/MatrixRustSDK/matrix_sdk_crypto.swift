...
public struct FfiConverterTypeQrCodeModeData: FfiConverterRustBuffer {
    typealias SwiftType = QrCodeModeData

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> QrCodeModeData {
        let variant: Int32 = try readInt(&buf)
        switch variant {
        
        case 1: return .login
        
        case 2: return .reciprocate(serverName: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: QrCodeModeData, into buf: inout [UInt8]) {
        switch value {
        ...
        case let .reciprocate(serverName):
            writeInt(&buf, Int32(2))
            FfiConverterString.write(serverName, into: &buf)
...
public func FfiConverterTypeQrCodeModeData_lift(_ buf: RustBuffer) throws -> QrCodeModeData {
    return try FfiConverterTypeQrCodeModeData.lift(buf)
}

public func FfiConverterTypeQrCodeModeData_lower(_ value: QrCodeModeData) -> RustBuffer {
    return FfiConverterTypeQrCodeModeData.lower(value)
}



extension QrCodeModeData: Equatable, Hashable {}
